...
"""
Code taken from https://github.com/roundar/myjson
This file is supposed to be available as a pip install but the install
is broken so I copied it to here as it has a WTFPL license
It allows you to store and generate a URL to JSON data at myjson.com
"""
